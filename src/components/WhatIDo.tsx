    ...
    <div className="whatIDO">
      ...
      <div className="what-box">
        <div className="what-box-in">
          <div
            className="what-content what-noTouch what-card-data"
            ref={(el) => setRef(el, 0)}
          >
            <div className="what-content-in">
              <div className="what-heading-row">
                <div className="what-icon-badge what-icon-badge-data">
                  <FiDatabase />
                </div>
          ...
          <div
            className="what-content what-noTouch what-card-code"
            ref={(el) => setRef(el, 1)}
          >
            <div className="what-content-in">
              <div className="what-heading-row">
                <div className="what-icon-badge what-icon-badge-code">
                  <FiCode />
                </div>
